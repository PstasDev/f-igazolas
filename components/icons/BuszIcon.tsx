...
interface BuszIconProps {
  className?: string;
  size?: number;
  color?: string;
}

export const BuszIcon: React.FC<BuszIconProps> = ({ 
  className = '', 
  size = 24, 
  color = '#009EE3' 
}) => {
  return (
    ...
    >
      <g>
        <path 
          fill={color} 
          d="M249.987,0.01C112.16,0.01,0,112.156,0,250.01c0,137.833,112.16,249.98,249.987,249.98
            C387.84,499.99,500,387.843,500,250.01C500,112.156,387.84,0.01,249.987,0.01"
        />
        <path 
          fill="#FFFFFF" 
          d="M358.528,339.883c0,4.275-3.503,7.753-7.753,7.753H294.74c-4.263,0-6.285-3.168-4.521-7.058l7.071-15.506
